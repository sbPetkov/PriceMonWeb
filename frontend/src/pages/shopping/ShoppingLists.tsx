    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Shopping Lists</h1>
            <p className="text-gray-500 mt-1">Organize your shopping and compare prices</p>
          </div>
          <button
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          by {list.owner?.first_name || list.owner?.username || 'Unknown'}
                        </p>
                      </div>
                      <button
                        onClick={(e) => {
                    ...
                    <div className="flex items-center gap-4 mb-4 text-sm">
                      ...
                      <div className="flex items-center gap-1.5 text-gray-600">
                        ...
                        <span>
                          {list.member_count === 0 ? 'Just you' : `${list.member_count + 1} ${list.member_count + 1 === 1 ? 'member' : 'members'}`}
                        </span>
                      </div>
                    </div>
                    ...
                    {list.item_count > 0 && (
                      <div className="mb-4">
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          {list.checked_count} of {list.item_count} completed
                        </p>
                      </div>
                    )}
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-md w-full p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Create Shopping List</h3>
